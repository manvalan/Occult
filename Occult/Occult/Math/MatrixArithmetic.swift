...
public func * (_ M: Matrix, _ A: Vector) -> Vector {
    var i :Int
    var j :Int
    precondition(M.cols == A.count, "Matrix dimensions and Vector dimensin must agree")
    var VR = Vector(repeating: 0.0, count: M.rows )
